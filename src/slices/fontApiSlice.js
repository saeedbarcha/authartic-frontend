...
export const { useGetAllFontsQuery, useGetAdminAllFontsQuery, useGetAdminALLFontsCountQuery, useCreateAdminNewFontMutation, useUpdateAdminFontMutation, useDeleteAdminFontMutation } = allFontApiSlice;
